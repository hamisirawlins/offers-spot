...
You should have two terminals open in both the server and client directories

# Install Dependencies
To install necessary dependencies, run the following command in the two terminals
```````````
npm install
